...
public class SkillController {
    ...
    @PostMapping
    public ResponseEntity<BaseResponse> create(@RequestBody SkillDto request) {
        return ResponseEntity.status(HttpStatus.CREATED).body(skillService.create(request));
    }

    @PutMapping("/{id}")
    public ResponseEntity<BaseResponse> update(@PathVariable UUID id, @RequestBody SkillDto request) {
    ...
    @PostMapping("/page")
    public ResponseEntity<BaseResponse> getPage(@RequestBody SkillSearchRequest request) {
        return ResponseEntity.ok(skillService.getPage(request));
    }
}
